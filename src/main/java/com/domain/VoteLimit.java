...
@ApiModel(value="com-domain-VoteLimit")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
...
public class VoteLimit implements Serializable {
     ...
     * 投票限制名称
     */
    @TableField(value = "vote_limit_name")
    @ApiModelProperty(value="投票限制名称")
    ...
    public static final String COL_VOTE_LIMIT_NAME = "vote_limit_name";
